    ...
    echo \kartik\builder\Form::widget([
        ...
        'attributes' => [
            'Indicator' => [
                ...
                'items' => ArrayHelper::map(Indicators::findBySql("SELECT indicator_id, indicator_description FROM tbl_fp_indicators WHERE (disagg_area_type_id is not null OR disagg_group_id is not null OR source_type_id = 'MUL')")->orderBy('indicator_id')->asArray()->all(), 'indicator_id', 'indicator_description'), 'options' => ['prompt' => 'Select Disaggregated indicator'],
                'columnOptions' => ['id' => 'Indicator-id']
            ],
            'ResultAreas' => [
                'type' => Form::INPUT_DROPDOWN_LIST,
