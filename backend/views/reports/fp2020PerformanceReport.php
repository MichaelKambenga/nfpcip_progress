 ...
 */
$this->title = Yii::t('app', 'FP2020 Performance Report');
?>
<?php
echo $this->render('_formFp2020PerformanceReport', ['model' => $model]);
?>
...
<br/>
    ...
    <h5>FP2020 Performance Report:- <?php echo date('F Y', strtotime($from_date)) . ' to ' . date('F Y', strtotime($to_date)) ?></h5>
